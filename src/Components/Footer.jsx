...
const Footer = () => {
    ...
    const socialLinks = [
        { icon: 'slack', url: '#', label: 'Slack' },
        { icon: 'twitter', url: '#', label: 'Twitter' },
        { icon: 'youtube', url: '#', label: 'YouTube' },
        { icon: 'tiktok', url: '#', label: 'TikTok' },
        { icon: 'instagram', url: '#', label: 'Instagram' },
        { icon: 'linkedin', url: '#', label: 'LinkedIn' },
        { icon: 'medium', url: '#', label: 'Medium' },
    ];
            ...
            <div className="container">
                <div className="footer-content">
                    <div className="footer-left">
                        ...
                        <p className="footer-copyright">© 2025 Aswenna. All rights reserved.</p>
                    </div>
                            ...
                            {developers.map((dev, index) => (
                                ...
                                >
                                    ...
                                    <div className="avatar-tooltip">
                                        <div className="tooltip-name">{dev.name}</div>
                                        <div className="tooltip-role">{dev.role}</div>
                                    </div>
                                </div>
                            ))}
                        </div>
